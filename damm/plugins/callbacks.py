...
class CallbackSet(memobj.MemObjectSet):
    ...
    def get_unique_id(self, call):
        '''
        @return: the default unique id for Callbacks memobjs
        '''
        return (call.fields['type'],call.fields['module'], call.fields['callback'],call.fields['detail'])
