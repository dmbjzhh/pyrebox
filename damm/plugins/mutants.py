...
####dln
    ...
    def get_unique_id(self, muta):
        '''
        @return: the default unique id for Mutants memobjs
        '''
        return (muta.fields['offset'],muta.fields['process_id'], muta.fields['num_pointer'],muta.fields['num_handles'],muta.fields['mutant_name'])
