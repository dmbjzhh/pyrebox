...
import damm.memory_object as memobj
...
####dln
    ...
    def get_unique_id(self, mess):
        '''
        @return: the default unique id for Messagehook memobjs
        '''
        return (mess.fields['session'], mess.fields['desktop'], mess.fields['thread'], mess.fields['filter'],mess.fields['flags'],mess.fields['function'],mess.fields['module'])
