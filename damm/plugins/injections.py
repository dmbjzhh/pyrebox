...
####dln
    ...
    def get_unique_id(self, injec):
        '''
        @return: the default unique id for Injections memobjs
        '''
        return (injec.fields['task_unique_proces_id'],injec.fields['task_image_file_name'],injec.fields['address'])
