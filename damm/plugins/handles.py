...
####dln
    ...
    def get_unique_id(self, hand):
        '''
        @return: the default unique id for handles memobjs
        '''
        return (hand.fields['pid'], hand.fields['handle_value'], hand.fields['granted_access'], hand.fields['object_type'],hand.fields['name'])
