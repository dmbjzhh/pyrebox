...
####dln
    ...
    def get_unique_id(self, evtl):
        '''
        @return: the default unique id for Evtlogs memobjs
        '''
        return (evtl.fields['time_written'],evtl.fields['path'], evtl.fields['source'], evtl.fields['msg'])
