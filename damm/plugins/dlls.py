...
####dln
    ...
    def get_unique_id(self, dlls):
        '''
        @return: the default unique id for Dlls memobjs
        '''
        return (dlls.fields['process_id'], dlls.fields['process_name'], dlls.fields['dll_mapped_path'])
